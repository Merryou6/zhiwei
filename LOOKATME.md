...
- **已知遗留与裁决（2026-09-24 总控裁定：接受现状、不处理）**：恰好 **720px** 一处 1px 边界差异——旧写法
  `max-[720px]:hidden` 生成 `max-width:720px`（**含**端点），新写法 `max-nav:hidden` 生成 `max-width:719.98px`（**不含**端点）；
