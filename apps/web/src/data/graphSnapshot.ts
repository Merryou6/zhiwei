 ...
 *
 * 生成来源：data/knowledge/math/cz.json（20 节点，4 章节）。
 * 生成脚本：/tmp 一次性脚本（node，读上表 → 写本文件），非工程文件。
 */
...
export const GRAPH_NODES: readonly GraphNodeSnapshot[] = [
  {
    ...
    "prerequisites": [],
    "successors": [
      "math.cz.algebra.identity",
      "math.cz.function.linear"
    ]
  },
  {
  ...
  },
  {
    ...
    "difficulty": 2,
    "prerequisites": [
      "math.cz.function.concept"
    ],
    "successors": [
      "math.cz.quadratic.graph_basic",
      "math.cz.quadratic.vertex_form"
    ]
  },
  {
    ...
    "successors": [
      "math.cz.quadratic.three_points"
    ]
  },
  {
  ...
  },
  {
    ...
    "successors": [
      ...
      "math.cz.quadratic.general_to_vertex"
    ]
  },
  {
